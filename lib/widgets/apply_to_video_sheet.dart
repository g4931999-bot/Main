...
class _ApplyToVideoSheetState extends State<_ApplyToVideoSheet> {
  ...
  Future<void> _confirmApply() async {
    ...
    try {
      ...
      if (mounted) {
        showToast(context, 'Video updated!', isSuccess: true);
        ...
        child: Column(
          ...
          children: [
            Row(children: [
              ...
              const Text('Apply to Video', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
            ]),
            const SizedBox(height: 4),
            Text(
              'Pick a queued video and platform to update with this text.',
            ...
            if (_loading)
              ...
              const EmptyView(message: 'No queued videos to apply this to — upload one first.', icon: Icons.video_library_outlined)
            else ...[
              ..._videos.map((v) {
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: selected ? AppColors.purple.withOpacity(0.08) : null,
                    ),
                    child: Row(children: [
              ...
              if (_selectedVideoId != null && platformTargets.isNotEmpty) ...[
                ...
                Text('Platform', style: TextStyle(color: context.surfaces.textDim, fontSize: 12, fontWeight: FontWeight.w700)),
  ...
  String _videoLabel(Map<String, dynamic> v) {
    ...
    return firstTitle ?? '(untitled video)';
  }
}
